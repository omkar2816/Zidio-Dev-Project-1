            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="bg-gray-50 dark:bg-gray-900/50">
                <tr>
                  ...
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden sm:table-cell">Email</th>
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Role</th>
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden md:table-cell">Status</th>
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden lg:table-cell">Last Login</th>
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden lg:table-cell">Created</th>
                  ...
                  <tr key={u._id}>
                    <td className="px-3 py-4 text-sm text-gray-900 dark:text-gray-100">
                      <div>
                        ...
                        <div className="text-gray-500 dark:text-gray-400 sm:hidden">{u.email}</div>
                      </div>
                    </td>
                    <td className="px-3 py-4 text-sm text-gray-600 dark:text-gray-300 hidden sm:table-cell">{u.email}</td>
                    ...
                    <td className="px-3 py-4 text-sm text-gray-600 dark:text-gray-300 hidden lg:table-cell">{u.lastLogin ? new Date(u.lastLogin).toLocaleString() : '—'}</td>
                    <td className="px-3 py-4 text-sm text-gray-600 dark:text-gray-300 hidden lg:table-cell">{u.createdAt ? new Date(u.createdAt).toLocaleString() : '—'}</td>
