          ...
          <nav className="-mb-px flex space-x-8">
            {[
              ...
              <button
                ...
                className={`flex items-center space-x-2 py-2 px-4 border-2 font-medium text-sm rounded-t-lg transition-all duration-200 ${
                  activeTab === tab.id
                    ? 'border-blue-500 border-b-white text-blue-600 bg-white shadow-sm'
                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 hover:bg-gray-50 rounded-lg'
                }`}
              >
